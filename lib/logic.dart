...
// Rail fence keyword encryption and decryption
  String railfenceEncrypt(String text, int key) {
    ...
    String result = '';
    bool dir = false;
    var matrix = List.generate(row, (i) => List<dynamic>.filled(row, col));
    for (var i = 0; i < text.length; i++) {
  ...
  String railfenceDecrypt(String text, int key) {
    ...
    bool dir = true;
    var matrix = List.generate(key, (i) => List<dynamic>.filled(key, text.length));
...
// Playfair cipher encryption & decryption
  ...
  String playfairEncrypt(String text, String key) {
    ...
    var matrix = List.generate(5, (i) => List<dynamic>.filled(5, 5)), index = 0;
