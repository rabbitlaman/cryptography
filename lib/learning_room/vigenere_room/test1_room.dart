...
class VigenereTest1 extends StatefulWidget {
  const VigenereTest1({super.key});

  @override
  State<VigenereTest1> createState() => _VigenereTest1State();
}

class _VigenereTest1State extends State<VigenereTest1> {
  @override
  bool check1 = false,
      check2 = false,
      check3 = false,
  ...
  String answer = 'wsmyvwzywyxq', answer1 = 'ihateyou', congratu = '';
